          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 animate-fade-in">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-yellow-800">Image Quality Warning</h4>
                <p className="text-sm text-yellow-700 mt-1">
                  Low-quality X-ray may affect accuracy. For best results, ensure the image is clear and properly exposed.
                </p>
                <button 
        ...
        {history.length > 0 && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-blue-900">Your Scan Insights</h3>
            </div>
